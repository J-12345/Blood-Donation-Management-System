...
(1, 'Blood Emergency', 'B+', '2018-06-24', 'Helping Hands', 'Weight at least 50kg, No alcohol intake in 24hrs prior to donation, light meal should be taken before donation, be in good health, must be 18 years old and must have at least 3 month interval than the last donation.'),
...
(8, 'Saving Lives Together', 'Vishal Tripathy', 7999408881, '2018-06-21', 'Saving Lives Together, or SLT, is a series of recommendations aimed at enhancing security collaboration between the United Nations, International Non-Governmental Organizations and International Organizations');
...
(19, 'Harry Den', 'Stephen Den', 'M', '1998-06-17', 70, 'B+', 'harry.den20@gmail.com', 'Tumkur', '7854445420', 'harry', 'pass'),
(20, 'Will Williams', 'Reth R Williams', 'M', '1996-07-16', 70, 'A+', 'williams@gmail.com', 'Afzalpur', '0248887540', 'williams', 'williams'),
(21, 'John Doe', 'Kevin Doe', 'M', '1991-12-09', 69, 'AB+', 'doejohn@gmail.com', 'Belgaum', '7854445470', 'johnd', 'password'),
(22, 'Ramona Jr Pippin', 'Noramo Pippin', 'F', '1995-02-22', 55, 'O-', 'pippin@gmail.com', 'Davanagere', '7854445200', 'pippin', 'password'),
(23, 'Robert', 'Simon L Berg', 'M', '1994-06-21', 82, 'AB-', 'robert@gmail.com', 'Hampi', '2547778452', 'robert', 'robert');
...
(1, 'jessica', 'pass', 'Jessica Bhagtani');
