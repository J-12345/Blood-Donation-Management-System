                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Please make your changes by updating the form:
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    $id = $_GET['id'];
                                    $qry = "select * from ngo where id='$id'";
                                    $result = mysqli_query($conn, $qry);
                                    while ($row = mysqli_fetch_array($result)) {

                                    ?>
                                        <form role="form" action="editngoutil.php" method="post">

                                            <div class="form-group">
                                                <label>Enter NGO Name</label>
                                                <input class="form-control" name="name" type="text" value='<?php echo $row['name']; ?>' required>
                                                <p class="help-block">Example:Samajseva NGO</p>
                                            </div>
