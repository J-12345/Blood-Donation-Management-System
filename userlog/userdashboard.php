                  ...
                  <div class="col-lg-12 col-md-12">
                      <div class="panel panel-red">
                          <div class="panel-heading">
                              <div class="row">
                                  <div class="col-xs-4">
                                  <div class="large">Why hould you donate blood? </div>
                                  </div>
                          ...
                          <a href="https://www.redcrossblood.org/local-homepage/news/article/blood-donation-importance.html">
                              <div class="panel-footer">
                                  <span class="pull-left">www.redcrossblood.org</span>
                                  <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                  <div class="clearfix"></div>
                              </div>
                          </a>
                          <a href="https://www.blood.co.uk/why-give-blood/">
                              <div class="panel-footer">
                                  <span class="pull-left">www.blood.co.uk</span>
                                  <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                  <div class="clearfix"></div>
                              </div>
                          </a>
                          <a href="https://givingblood.org/donate-blood/why-give-blood.aspx">
                              <div class="panel-footer">
                                  <span class="pull-left">givingblood.org</span>
                                  <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                  <div class="clearfix"></div>
                              </div>
                          </a>
